...
if (dayz_actionInProgress) exitWith {localize "str_player_actionslimit" call DZE_fnc_rollingMessages;};	// Wait for the previous action to complete to perform another!
...
//	s_player_packvault = -1;
	format[localize "str_epoch_player_119", _text] call DZE_fnc_rollingMessages;	// You cannot pack this %1, you do not know the combination.
};
...
format[localize "str_epoch_player_123", _text] call DZE_fnc_rollingMessages;	// Your %1 has been packed
