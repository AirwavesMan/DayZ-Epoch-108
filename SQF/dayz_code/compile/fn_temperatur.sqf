...
//	local _fireplaces = nearestObjects [_pos, ["DZE_flamable","Land_Fire","Land_Campfire"], 8];
	local _fireplaces = nearestObjects [player, ["DZE_flamable","Land_Fire","Land_Campfire"], 8];
