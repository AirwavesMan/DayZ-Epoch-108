...
local _useKit = _refundKit != '' && {DZE_refundMode == 'kit' || {count _refundArrays == 0}};
...
#ifdef DEBUG_DZE_FNC_GET_REMOVE_REFUND
	diag_log format ['[Client Debug]: [DZE_fnc_getRemoveRefund]: Object type: %1 | Preferred mode: %2 | Refund: %3',_objectType,DZE_refundMode,_validatedRefund];
#endif
