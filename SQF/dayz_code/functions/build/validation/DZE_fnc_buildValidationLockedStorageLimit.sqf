...
//
//	Description:	Rejects building when DZE_LockedStorageLimit has been reached by the classes
//			listed in DZE_LockedStorage inside the active base.
...
local _result = [_className,_subject,_object,DZE_LockedStorage,DZE_LockedStorageLimit,_nearestPole] call DZE_fnc_checkBuildGroupLimit;
