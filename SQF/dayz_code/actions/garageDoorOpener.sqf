...
call {
	...
	if (_typeof in ['DZE_CinderGarageOpenTopLocked','DZE_Land_WoodOpenTopGarageLocked']) exitwith {
	...
	if (_typeof in ['DZE_CinderGateLocked','DZE_Land_WoodGateLocked']) exitwith {
