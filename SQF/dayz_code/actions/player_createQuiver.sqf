...
//if (_qty_quivers > 0) exitWith { localize "str_quiver_reachlimit" call DZE_fnc_rollingMessages;};
if (_qty_arrows < 2) exitWith { localize "str_quiver_notenougharrows" call DZE_fnc_rollingMessages;}; //Not enough arrows to create 12Rnd_Quiver_Wood
...
format[localize "str_quiver_createsuccess",_qty_quiverarrows] call DZE_fnc_rollingMessages;
