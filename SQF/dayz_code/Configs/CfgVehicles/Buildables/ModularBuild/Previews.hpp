...
class DZE_Ghost_Previews: NonStrategic {
	vehicleClass = "DayZ Epoch 1071 Previews (Legacy)";
	scope = 0;
...
class DZE_Drawbridge_Preview: DZE_Ghost_Previews {
	scope = 2;
...
class DZE_CinderGarageOpenTop_Preview: DZE_Ghost_Previews {
	scope = 2;
...
class DZE_DoorFrame_Preview: DZE_Ghost_Previews {
	scope = 2;
	model = "\z\addons\dayz_epoch\models\Steel_door_frame_single_ghost.p3d";
	displayName = "Door Frame Preview";
};

class DZE_CinderWallWindow_Preview: DZE_Ghost_Previews {
	scope = 2;
...
class DZE_CinderDoorHatch_Preview: DZE_Ghost_Previews {
	scope = 2;
